      ...
      <div style={{ paddingTop: '35px' }}>
        <Grid container spacing={4}>
            <div dangerouslySetInnerHTML={{
              __html: ' <h2>Política Privacidade</h2> \
<p>A sua privacidade é importante para nós. É política do InfoAqui respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=http://www.infoaqui.net.br/>InfoAqui</a>, e outros sites que possuímos e operamos.</p> \
...
<h2>Política de Cookies InfoAqui</h2> \
...
<ul> \
	<li>                            Cookies relacionados à conta<br> \
			<br> Se você criar uma conta connosco, usaremos cookies para o gerenciamento do processo de inscrição e administração geral. Esses cookies geralmente serão excluídos quando você sair do sistema, porém, em alguns                            casos, eles poderão permanecer posteriormente para lembrar as preferências do seu site ao sair.<br> \
					<br> \
					</li> \
					<li>                            Cookies relacionados ao login<br> \
							<br> Utilizamos cookies quando você está logado, para que possamos lembrar dessa ação. Isso evita que você precise fazer login sempre que visitar uma nova página. Esses cookies são normalmente removidos ou limpos                            quando você efetua logout para garantir que você possa acessar apenas a recursos e áreas restritas ao efetuar login.<br> \
									...
									<li>                            Cookies relacionados a boletins por e-mail<br> \
											<br> Este site oferece serviços de assinatura de boletim informativo ou e-mail e os cookies podem ser usados ​​para lembrar se você já está registrado e se deve mostrar determinadas notificações                            válidas apenas para usuários inscritos / não inscritos.<br> \
													<br> \
													</li> \
													<li>                            Pedidos processando cookies relacionados<br> \
															<br> Este site oferece facilidades de comércio eletrônico ou pagamento e alguns cookies são essenciais para garantir que seu pedido seja lembrado entre as páginas, para que possamos processá-lo adequadamente.<br> \
																	<br> \
																	</li> \
																	<li>                            Cookies relacionados a pesquisas<br> \
																			<br> Periodicamente, oferecemos pesquisas e questionários para fornecer informações interessantes, ferramentas úteis ou para entender nossa base de usuários com mais precisão. Essas pesquisas podem usar cookies                            para lembrar quem já participou numa pesquisa ou para fornecer resultados precisos após a alteração das páginas.<br> \
																					...
																					<li>                            Cookies relacionados a formulários<br> \
																							<br> Quando você envia dados por meio de um formulário como os encontrados nas páginas de contacto ou nos formulários de comentários, os cookies podem ser configurados para lembrar os detalhes do usuário                            para correspondência futura.<br> \
																									<br> \
																									</li> \
																									<li>                            Cookies de preferências do site<br> \
																											...
																											<ul> \
																												...
																												<p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o InfoAqui oferece no site e com caráter enunciativo, mas não limitativo:</p> \
																												<ul> \
																													...
																													<li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do InfoAqui, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li> \
																												</ul> \
